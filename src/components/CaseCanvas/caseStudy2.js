...
function renderStep1_3_1() {
    ...
    renderImage({
        ...
        y: text.y() + text.height() + 20,
        maxWidth: stageInstance.getWidth() * 0.8,
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/1.3.1.jpg'
    }).then((imageObject) => {
        let text2 = renderText({
            x: 0,
            y: imageObject.y() + imageObject.height() + 20,
...
function renderStep4_1_1() {
    ...
    renderImage({
        ...
        maxWidth: stageInstance.getWidth(),
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/4.1.1.png'
    })
}
...
function renderStep8_1_1() {
    renderImage({
        ...
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.1.1.jpg'
    })
...
function renderStep8_1_14() {
    ...
    renderImage({
        ...
        y: 0,
        maxWidth: stageInstance.getWidth(),
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.1.14.png'
    })
}
...
function renderStep8_1_15() {
    ...
    renderImage({
        ...
        y: 0,
        maxWidth: stageInstance.getWidth(),
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.1.15.png'
    })
}
...
function renderStep8_2_1() {
    renderImage({
        ...
        y: 0,
        maxWidth:  stageInstance.getWidth()*0.6,
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.2.1.jpg'
    })
}
...
function renderStep8_2_17() {
    ...
    renderImage({
        ...
        y: 0,
        maxWidth: stageInstance.getWidth(),
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.2.17.jpg'
    })
}
...
function renderStep8_2_18() {
    ...
    renderImage({
        ...
        y: 0,
        maxWidth: stageInstance.getWidth(),
        imageSrc: apiBaseUrlCase + '/assets/images/caseStudy/'+currentCaseStudyID+'/8.2.18.png'
    })
}
