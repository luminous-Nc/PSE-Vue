    ...
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 shadow-lg">
        <div class="flex flex-wrap items-center justify-between mx-auto px-4 py-2">
            ...
            <div class="block w-auto" id="navbar-default">
                <ul class="font-medium flex p-0 border-gray-100 rounded-lg  flex-row space-x-8 rtl:space-x-reverse mt-0 border-0 bg-white dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="/"
                              class="block py-2 px-3 rounded bg-transparent text-blue-700 p-0 dark:text-blue-500">Learn</a>
                    </li>
                    <li>
                        <a href="/about"
